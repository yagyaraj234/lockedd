...
const SearchEmptySVG = ({ c }: { c: Palette }) => (
  <Svg width={100} height={100} viewBox="0 0 100 100" fill="none">
    {/* Magnifying glass */}
    <Circle cx="42" cy="42" r="25" fill={c.illustrationBg} stroke={c.illustrationLine} strokeWidth="2.5" />
    ...
    <Line x1="31" y1="37" x2="53" y2="37" stroke={c.illustrationLineSoft} strokeWidth="1.5" strokeLinecap="round" />
    <Line x1="31" y1="43" x2="53" y2="43" stroke={c.illustrationLineSoft} strokeWidth="1.5" strokeLinecap="round" />
    <Line x1="35" y1="49" x2="49" y2="49" stroke={c.illustrationLineSoft} strokeWidth="1.5" strokeLinecap="round" />
  </Svg>
);
...
const LockEmptySVG = ({ c }: { c: Palette }) => (
  <Svg width={100} height={100} viewBox="0 0 100 100" fill="none">
    {/* Lock body */}
    <Rect x="22" y="46" width="56" height="40" rx="8" fill={c.illustrationBg} stroke={c.illustrationLine} strokeWidth="2" strokeDasharray="6 4" />
    {/* Lock shackle */}
    <Path
